...
const admin_vouchers_all_users_scene = new BaseScene('admin_vouchers_all_users_scene');
admin_vouchers_all_users_scene.enter(async (ctx) => {
    await ctx.editMessageText(ctx.i18n.t("admin_vouchers_all_users_scene"), {
        parse_mode: "HTML",
        reply_markup: back_keyboard("admin_vouchers").reply_markup
    });
});

admin_vouchers_all_users_scene.on('text', async (ctx) => {
    ...
    return ctx.scene.enter("admin_vouchers_all_users_scene_2")
});

const admin_vouchers_all_users_scene_2 = new BaseScene('admin_vouchers_all_users_scene_2');
admin_vouchers_all_users_scene_2.enter(async (ctx) => {
    try {
        await ctx.editMessageText(ctx.i18n.t("admin_vouchers_all_users_scene_2"), {
            parse_mode: "HTML",
            reply_markup: back_keyboard("back").reply_markup
        });
    } catch (err) {
        ctx.replyWithHTML(ctx.i18n.t("admin_vouchers_all_users_scene_2"), back_keyboard("back"));
    }
});

admin_vouchers_all_users_scene_2.action('back', (ctx) => {
    return ctx.scene.enter("admin_vouchers_all_users_scene")
});

admin_vouchers_all_users_scene_2.on('text', async (ctx) => {
    ...
    return ctx.scene.enter("admin_vouchers_all_users_scene_3")
});

const admin_vouchers_all_users_scene_3 = new BaseScene('admin_vouchers_all_users_scene_3');
admin_vouchers_all_users_scene_3.enter(async (ctx) => {
    const count = await $user.countDocuments();
    try {
        await ctx.editMessageText(ctx.i18n.t("admin_vouchers_all_users_scene_3", {
        ...
        ctx.replyWithHTML(ctx.i18n.t("admin_vouchers_all_users_scene_3", {
            count: ctx.session.count,
            count_users: count
        }), yes_no_keyboard());
    }
...
admin_vouchers_all_users_scene_3.action('no', (ctx) => {
    return ctx.scene.enter("admin_vouchers_all_users_scene_2")
});

admin_vouchers_all_users_scene_3.action('yes', async (ctx) => {
    ...
    await ctx.editMessageText(ctx.i18n.t("admin_vouchers_all_users_scene_finish", {
        count: ctx.session.count,
